...
<div class="index_main w1180 front">
    ...
    <div class="login_front">
        ...
        <p class="fs_24 bold m">注册送10000元体验金</p>
         <span id="static_banner_login"><a title="免费注册" rel="nofollow" href="{{url('auth/reg')}}" class="btn_orange">免费注册</a><a title="马上登录" rel="nofollow" class="orange" href="{{url('auth/login')}}">马上登录</a></span>
    </div>
    @else
    <div class="login_front">
        <p class="fs_24 t">安全、稳健、高收益</p>
        <p class="fs_24 bold m">首次投资领大礼包</p>
         <span id="static_banner_login"><a title="免费注册" rel="nofollow" href="{{url('auth/reg')}}" class="btn_orange">马上投资</a><a title="马上登录" rel="nofollow" class="orange" href="{{url('auth/login')}}">查看详情</a></span>
    </div>
    @endif
</div>
                ...
                <div class="fl pro_con">
                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            <li class="w6">
                                <p class="fc_9 mb_5">项目名称 </p>
                                <p style="color:#f60;font-size:16px;font-weight:bold; ">{{$pro->title}}
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{$pro->recive/100}}/{{$pro->money/100}}</p>
                            </li>
                            <li class="w4">
