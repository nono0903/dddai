                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            @forelse($list as $list)
                                <tr>
                                   <td class="f">{{$list->pid}}</td>
                                   <td>{{date('Y/m/d H:i:s',$list->pubtime)}}</td> 
                                   <td class="tr"><span>{{$list->name}}</span></td> 
                                   <td class="tr">{{sprintf('%.2f',$list->money/100)}}</td> 
                                   <td class="tr">{{$list->mobile}}</td>
                                   <td class="">
                                @if($list->status==0)
                                        <font color="">待审核</font>

                                @elseif($list->status==1)
                                        <font color="red">招标中</font>
                                ...
                                @endif
                                   ...
                                   <td class="l"><a href="{{url('shenhe',$list->pid)}}">审核</a></td>
                                </tr>
                            @empty
