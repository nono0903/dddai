...
<div class="crumbs userCrumbs">
    <a class="first" href="#">账户中心</a><span>&gt;</span><a class="two" href="#">借款管理</a><span>&gt;</span><a class="two">我的贷款</a>
</div>
<!--面包屑 end-->
<!--layout start-->
    ...
    <div class="clearfix main_wrapper">
    	<div class="container">
            <div class="accountCenter">
                <span class="fs_18 left">我的贷款</span>
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                @forelse($dk as $dk)
                                                            <tr>
                                   <td class="f">{{$dk->pid}}</td>
                                   <td class="f"><span>{{$dk->title}}</span></td> 
                                   <td class="f"><font color="green">{{sprintf('%.2f',$dk->money/100)}}</font></td> 
                                   <td class="f"><font color="red">{{sprintf('%.2f',$dk->recive/100)}}</font></td> 
                                   <td class="f">{{date('Y/m/d H:i:s',$dk->pubtime)}}</td> 
                                    <td class="f">
                                    @if($dk->ststus==0)
                                    审核中
                                    @elseif($dk->ststus==1)
                                    <font color="blue">筹款中</font>  
                                    @elseif($dk->ststus==2) 
                                    <font color="green">还款中</font>  
                                    @elseif($dk->ststus==3)  
