                ...
                <div class="fl l">
                	<h3 class="pl_20 t_bt"><img src="/image/safe_safe_002.png"><span class="fc_green pl_10">账户资金安全由银行委托管理</span></h3>
	                      <ul class="clearfix td_all">
	                    	<li class="fl ">
                                <h4 class="fc_9 pl_20">订单号：{{$v_oid}}</h4>
                                <p class="pl_20 fs_18 fc_6">
                                您将对<font color="red">{{$title}}</font>项目投资{{$v_amount}}元，是否确认继续付款以完成操作？
                                 </p>
                                 <p>{{$v_md5info}}</p>
                            </li>
                	...
                	<div class="td_all2">
                        <table width="100%" class="fc_6">
                            ...
                            <tr>
                                ...
                                <td style="padding-right:0;width:220px;"><font color="red">{{$v_amount}}元</font></td>

                            </tr>                          
                        </tbody>
                        </table>
                        <div class="fc_6 t_r b1 newstyle" style="padding-top:100px;">
                        <form method=post action="http://localhost/pay/">
