	                      ...
	                      <ul class="clearfix td_all">
	                        ...
	                        <li class="fl td5">
	                            ...
	                            <p><span class="airal fs_24 fc_orange">
	                                   {{(sprintf('%.2f',$pro->recive/100)).'/'.(sprintf('%.2f',$pro->money/100))}}
	                            </span>元</p>
	                        </li>
                	...
                	<div class="td_all2">
                        ...
                        <table width="100%" class="fc_6">
                            ...
                            <tr>
                                ...
                                <td style="padding-right:0;width:220px;"><input type="text" name="touzi" style="width:140px;" class="fc_orange airal fs_18" value="{{sprintf('%.2f',($pro->money-$pro->recive)/100)}}">元</td>
                            </tr>
