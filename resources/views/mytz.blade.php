                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                @forelse($tz as $tz)
                                 <tr>
                                   <td class="f">{{$tz->pid}}</td>
                                   <td class="f">{{$tz->title}}</td>
                                   <td class="f">{{sprintf('%.2f',$tz->money/100)}}元</td>
                                   <td class="f">{{date('Y/m/d',$tz->pubtime)}}</td>
                                    
                                    <td class="f">
                                     @if($tz->status==1)                        
                                        <font color="green">招标中,快叫人来买</font>
                                     @elseif($tz->status==2) 
                                        <font color="red"> 发财了,涨利中</font>                      
                                      </td> 
                                     @endif
                                </tr>
                                @empty
